...
# Bir veri çerçevesi oluşturuyoruz
df = pd.DataFrame()
...
# İnsan sınıfı için nesne üretiyoruz
print("İnsan sınıfı için 2 nesne üretiniz.")
for i in range(2):
    insan_olustur()
    print(df.iloc[-1])

# İşsiz sınıfı için nesne üretiyoruz
print("İşsiz sınıfı için 3 nesne üretiniz.")
for i in range(3):
    issiz_olustur()
    print(df.iloc[-1])

# Çalışan sınıfı için  nesne üretiyoruz
print("Çalışan sınıfı için 3 nesne üretiniz.")
for i in range(3):
    calisan_olustur()
    print(df.iloc[-1])

# Mavi yaka sınıfı için nesne üretiyoruz
print("Mavi yaka sınıfı için 3 nesne üretiniz.")
for i in range(3):
    calisan_olustur()
    print(df.iloc[-1])

# Beyaz yaka sınıfı içinnesne üretiyoruz
